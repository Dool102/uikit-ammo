...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#1a233a", backgroundDisabled: "#E8E9EB", backgroundAlt: "#272e48", cardBorder: "#E9EAEB", contrast: "#191325", dropdown: "#F4F4F9", dropdownDeep: "#E2E6ED", invertedContrast: "#FFFFFF", input: "#DFE7F2", inputSecondary: "#DFE7F2", tertiary: "#101627", text: "#4f60d9", textDisabled: "#BDC2C4", textSubtle: "#8a99b5", disabled: "#E9EAEB", gradients: {
        bubblegum: "linear-gradient(139.73deg, #C1D0F4 0%, #DFE7F2 100%)",
        inverseBubblegum: "linear-gradient(139.73deg, #DFE7F2 0%, #C1D0F4 100%)",
        cardHeader: "linear-gradient(111.68deg, red 0%, #E2E6ED 100%)",
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "white", background: "#00000040", backgroundDisabled: "#3c3742", backgroundAlt: "#0303231a", cardBorder: "#38434C", contrast: "#191326", dropdown: "#1B1E1E", dropdownDeep: "#0E1214", invertedContrast: "#191326", input: "#3B3F56", inputSecondary: "#222B51", primaryDark: "#e3e1e1", tertiary: "#00000040", text: "#E1E7F9", textDisabled: "#BDC2C4", textSubtle: "white", disabled: "#4A5160", gradients: {
...
var socials = [
    ...
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/AmmoAvax",
    },
];
var MENU_HEIGHT = 64;
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://t.me/AmmoAvax", target: "_blank" },
